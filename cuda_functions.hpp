...
__global__ void Ms_mult(double *V, const double *const F, const double *const X, const int start_seg, const int num_segs);
__global__ void Mb_mult(double *V, const double *const F, const double *const X, const int start_blob, const int num_blobs);
